...
namespace Polly.Console.NSwag
{
    ...
    public partial class DemoClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> WeatherForecastAsync(int sleep)
        {
            return WeatherForecastAsync(sleep, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<WeatherForecast>> WeatherForecastAsync(int sleep, System.Threading.CancellationToken cancellationToken)
        {
            if (sleep == null)
                throw new System.ArgumentNullException("sleep");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/WeatherForecast/{sleep}");
            urlBuilder_.Replace("{sleep}", System.Uri.EscapeDataString(ConvertToString(sleep, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<bool> BreakerAsync(bool enable)
        {
            return BreakerAsync(enable, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<bool> BreakerAsync(bool enable, System.Threading.CancellationToken cancellationToken)
        {
            if (enable == null)
                throw new System.ArgumentNullException("enable");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/WeatherForecast/breaker/{enable}");
            urlBuilder_.Replace("{enable}", System.Uri.EscapeDataString(ConvertToString(enable, System.Globalization.CultureInfo.InvariantCulture)));
